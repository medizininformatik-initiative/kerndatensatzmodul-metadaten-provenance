...
```mermaid
graph LR
    KIS[("KIS-DRG-Aufbereitung<br/>UKB 2026-03-15")]
    ETL["ETL-Pipeline<br/>p21-to-fhir v1.4.2"]
    UKB["Org: UKB<br/>IKNR 260100000"]
    Patient[("Patient<br/>pat-mi-001")]
    Encounter[("Encounter<br/>enc-mi-001")]
    CondHD[("Condition HD<br/>I21.0")]
    CondND[("Condition ND<br/>I10.90")]
    Proc[("Procedure<br/>8-837.k0")]

    KIS -->|used as source| ETL
    UKB -.->|wasAssociatedWith<br/>(performer)| ETL
    ETL -->|generated| Patient
    ETL -->|generated| Encounter
    ETL -->|generated| CondHD
    ETL -->|generated| CondND
    ETL -->|generated| Proc

    classDef agent fill:#e1f5ff,stroke:#0288d1,color:#01579b
    classDef entity fill:#fff3e0,stroke:#f57c00,color:#e65100
    classDef activity fill:#f3e5f5,stroke:#7b1fa2,color:#4a148c
    class UKB agent
    class ETL activity
    class KIS,Patient,Encounter,CondHD,CondND,Proc entity
```
