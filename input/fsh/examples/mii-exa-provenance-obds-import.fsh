Instance: mii-exa-provenance-obds-import
InstanceOf: MII_PR_Provenance_Prozedur_Herkunft
Usage: #example
Title: "Provenance: Erstanlage aus oBDS-Import"
Description: "Beispiel: Die OP-Prozedur wurde aus dem oBDS-Melderegister via obds-to-fhir ETL in das DIZ-Repository importiert."
...
* target = Reference(Procedure/op-2)
...
* entity.what.display = "oBDS-Meldung Brustkrebs-OP"
