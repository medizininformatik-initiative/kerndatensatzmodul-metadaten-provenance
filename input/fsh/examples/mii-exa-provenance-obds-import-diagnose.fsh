Instance: mii-exa-provenance-obds-import-diagnose
InstanceOf: MII_PR_Provenance_Prozedur_Herkunft
Usage: #example
Title: "Provenance: Erstanlage Diagnose aus oBDS-Import"
Description: "Beispiel: Die Primärtumor-Diagnose wurde aus dem oBDS-Melderegister via obds-to-fhir ETL in das DIZ-Repository importiert."
...
* target = Reference(Condition/diagnose-brustkrebs)
...
* entity.what.display = "oBDS-Meldung Brustkrebs-Diagnose"
